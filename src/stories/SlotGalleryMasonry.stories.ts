...
import SlotGalleryMasonry from 'slot/SlotGalleryMasonry.svelte';

// // More on how to set up stories at: https://storybook.js.org/docs/svelte/writing-stories/introduction
const meta = {
	title: 'Slot/SlotGalleryMasonry',
	component: SlotGalleryMasonry,
	tags: ['autodocs']
} satisfies Meta<SlotGalleryMasonry>;
...
export const Custom: Story = {
	args: {
		content: content2,
		class: 'rounded-full border border-gray-900 m-20 gap-8'
	}
};
