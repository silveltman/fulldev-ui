...
<svelte:element
	this={as}
	class="w-full gap-x-md space-y-lg
    {masonry
		? 'columns-2 small:columns-2 large:columns-1 sm:columns-[308px] small:sm:columns-[220px] large:sm:columns-2 large:md:columns-[385px] [&>*]:break-inside-avoid-column'
